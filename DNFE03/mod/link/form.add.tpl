...
<div class="comment">
    <label for="title">{title}<i></i></label>
        <input class="width" name="title" id="title" type="text" required>
        <div class="clear-line"></div> 
    <label for="url">URL<i></i></label>
        <input class="width" name="url" id="url" type="text" required>
        <div class="clear-line"></div> 
    ...
    <div class="send">
        ...
        <button type="submit" class="sub send-but2"><span>{all_add}</span></button>
    </div>
    <div class="clear"></div>
</div>
</form>
